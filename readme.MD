...
bash
Copiar código
curl -X GET "http://localhost:8080/api/products/66b13b43a27616b8cae65171"
...
curl -X PUT -H "Content-Type: application/json" -d '{
  "price": 120.0
}' "http://localhost:8080/api/products/66b13b43a27616b8cae65171"
...
bash
Copiar código
curl -X DELETE "http://localhost:8080/api/products/66b13b43a27616b8cae65171"
🛒 Carrito de Compras
Ver el Carrito
Endpoint: /api/carts
Método: GET
...
curl -X POST -H "Content-Type: application/json" -d '{
  "quantity": 2
}' "http://localhost:8080/api/carts/add/66b13b43a27616b8cae65171"
...
curl -X POST -H "Content-Type: application/json" -d '{
  "quantity": 1
}' "http://localhost:8080/api/carts/remove/66b13b43a27616b8cae65171"
Vaciar el Carrito
